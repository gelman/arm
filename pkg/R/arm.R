...
#' \url{http://elsa.berkeley.edu/~imbens/matlab/lalonde_exper_04feb2.m}. Many
#' of these models are found to produce good balance for the Lalonde
#' data.
#'
#' @note This documentation is adapted from \code{Matching} package.
#' 
#' @references Dehejia, Rajeev and Sadek Wahba. 1999.``Causal Effects
#'   in Non-Experimental Studies: Re-Evaluating the Evaluation of
#'   Training Programs.'' \emph{Journal of the American Statistical
...
#' @seealso \code{\link{matching}}, \code{\link[Matching]{GenMatch}}
#'   \code{\link{balance}}
#' @docType data
#' @keywords datasets
#' @name lalonde
#' @usage data(lalonde)
#' @format A data frame with 445 observations on the following 12
#'   variables.
#' 
#'   \describe{
