...
#'
#' This function standardizes a variable by centering and dividing by
#' 2 sd's with exceptions for binary variables.
#'
#' @param x a vector.
#' @param binary.inputs options for standardizing binary variables,
#' default is \code{center}; \code{0/1} keeps original scale;
#' \code{-0.5,0.5} rescales 0 as -0.5 and 1 as 0.5; \code{center}
#' substracts the mean; and \code{full} substracts the mean and divids
#' by 2 sd.
...
#' Medicine} 27:
#' 2865--2873. \url{http://www.stat.columbia.edu/~gelman/research/published/standardizing7.pdf}
#' @author
